                ...
                <table class="table table-striped table-hover">
                    ...
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(action('\Sybace\Emailtemplates\Controllers\EmailTemplatesController@edit', $item->id)); ?>"><i class="fa fa-edit"></i> <?php echo e(trans('Core::operations.edit')); ?></a>
                            </td>
                        </tr>
