<?php 
    ...
    $action = action('\Sybace\Emailtemplates\Controllers\EmailTemplatesController@store');
    $method = '';
    ...
    $action = action('\Sybace\Emailtemplates\Controllers\EmailTemplatesController@update', $item->id);
    $method = 'PATCH';
