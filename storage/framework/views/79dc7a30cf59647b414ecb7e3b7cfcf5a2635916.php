...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="admin-top-operation">
            <a class="btn btn-default" href="<?php echo e(action('\Sybace\Articles\Controllers\ArticlesController@create')); ?>"><?php echo e(trans('Articles::articles.create')); ?> <?php echo e(trans('Articles::articles.article')); ?></a>
        </div>

        <?php if($items->count()): ?>
            <form method="POST" action="<?php echo e(action('\Sybace\Articles\Controllers\ArticlesController@bulkOperations')); ?>" id="bulk" class="form-inline">
                            ...
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr <?php if($item->trans): ?> data-title="<?php echo e($item->trans->name); ?>" <?php endif; ?>>
                                    ...
                                    <td>
                                        ...
                                        <?php endif; ?>
                                    <td>
                                       <a href="<?php echo e(action('\Sybace\Articles\Controllers\ArticlesController@edit', $item->id)); ?>"><i class="fa fa-edit"></i> <?php echo e(trans('Core::operations.edit')); ?></a>
        ...
        <?php else: ?>
            <div class="text-center">
                <?php if($_GET): ?>
                    <h1><?php echo e(trans('admin.no_results_found')); ?> <a href="<?php echo e(action('\Sybace\Articles\Controllers\ArticlesController@index')); ?>"><?php echo e(trans('admin.back')); ?></a></h1>
                <?php elseif(Request::is(''.Lang::getlocale().'/admin/ads')): ?>
                    <h1><?php echo e(trans('admin.no_data_added_before')); ?> <a href="<?php echo e(action('\Sybace\Articles\Controllers\ArticlesController@create')); ?>"><?php echo e(trans('Ads::ads.create')); ?> <?php echo e(trans('Ads::ads.ad')); ?></a></h1>
                <?php endif; ?>
             </div>
        <?php endif; ?>
    </div>
