...
<head>
    ...
    <?php if(isset($webmeta)): ?>
        <title><?php echo e(\Sybace\Settings\Models\Setting::find(1)->value); ?> - <?php echo e($webmeta['title']); ?></title>
        <meta name="description" content="<?php echo e($webmeta['description']); ?>">
        <meta name="keywords" content="<?php echo e($webmeta['keywords']); ?>">
    <?php else: ?>
        <title><?php echo e(\Sybace\Settings\Models\Setting::find(1)->value); ?> - Web Transformation, Digital Consultant & IT infrastructure</title>
    ...
    <meta property="og:description" content="sybace.com">
