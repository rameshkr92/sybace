        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-5 ms-footer-col ms-footer-text-right">
                <div class="ms-footbar-block">
                    ...
                    <address class="no-mb">
                        <p><i class="color-danger-light zmdi zmdi-pin mr-1"></i> <?php echo e(\Sybace\Settings\Models\Setting::find(2)->value); ?></p>
                        
                        <p>
                            <i class="color-info-light zmdi zmdi-email mr-1"></i>
                            <a href="mailto:<?php echo e(\Sybace\Settings\Models\Setting::find(3)->value); ?>"><?php echo e(\Sybace\Settings\Models\Setting::find(3)->value); ?></a>
                        </p>
                        <p>
                            <i class="color-royal-light zmdi zmdi-phone mr-1"></i><?php echo e(\Sybace\Settings\Models\Setting::find(4)->value); ?> </p>
                        <p>
                            <i class="color-success-light fa fa-fax mr-1"></i><?php echo e(\Sybace\Settings\Models\Setting::find(31)->value); ?> </p>
                    </address>
                </div>
                <div class="ms-footbar-block">
...
<footer class="ms-footer">
    <div class="container">
        <p>Copyright &copy; <?php echo e(date("Y")); ?> <?php echo e(\Sybace\Settings\Models\Setting::find(1)->value); ?> Web Technology Private Limited</p>
    </div>
