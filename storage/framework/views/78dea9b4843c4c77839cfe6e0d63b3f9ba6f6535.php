...
<div class="row">
    <div class="col-md-12">
        <div class="admin-top-operation">
            <a class="btn btn-default" href="<?php echo e(action('\Sybace\Banners\Controllers\BannersController@create')); ?>"><?php echo e(trans('Banners::banners.create')); ?> <?php echo e(trans('Banners::banners.banner')); ?></a>
        </div>
         <?php if($items->count() || $_GET): ?>
            <?php echo $__env->make('Banners::filter', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php endif; ?>
        <?php if($items->count()): ?>
        <form method="POST" action="<?php echo e(action('\Sybace\Banners\Controllers\BannersController@bulkOperations')); ?>" id="bulk" class="form-inline">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php endif; ?>
                            <td>
                                <a href="<?php echo e(action('\Sybace\Banners\Controllers\BannersController@edit', $item->id)); ?>"><i class="fa fa-edit"></i> <?php echo e(trans('Core::operations.edit')); ?></a>
        ...
        <div class="text-center">
            <?php if($_GET): ?>
            <h1><?php echo e(trans('admin.no_results_found')); ?> <a href="<?php echo e(action('\Sybace\Banners\Controllers\BannersController@index')); ?>"><?php echo e(trans('admin.back')); ?></a></h1>
            <?php elseif(Request::is(''.Lang::getlocale().'/admin/ads')): ?>
            <h1><?php echo e(trans('admin.no_data_added_before')); ?> <a href="<?php echo e(action('\Sybace\Banners\Controllers\BannersController@create')); ?>"><?php echo e(trans('Ads::ads.create')); ?> <?php echo e(trans('Ads::ads.ad')); ?></a></h1>
            <?php endif; ?>
        </div>
        <?php endif; ?>
    </div>
