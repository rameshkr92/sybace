    ...
    <div class="row">
        <div class="col-md-12">
            <div class="admin-top-operation">
                <a class="btn btn-default" href="<?php echo e(action('\Sybace\Blogs\Controllers\BlogsController@create')); ?>"><?php echo e(trans('Core::operations.create')); ?> <?php echo e(trans('Blogs::blogs.blog')); ?></a>
            </div>
