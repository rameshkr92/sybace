    ...
    <div class="col-md-12">
        ...
        <?php else: ?>
            <div class="text-center">
                ...
                <?php else: ?>
                    <h1> لا توجد بيانات للعرض<a href="<?php echo e(action('\Sybace\Pages\Controllers\PagesController@create')); ?>"><?php echo e(trans('Ads::ads.create')); ?> <?php echo e(trans('Ads::ads.ad')); ?></a></h1>
                <?php endif; ?>
             </div>
        <?php endif; ?>
    </div>
