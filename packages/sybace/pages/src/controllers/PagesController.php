<?php 
namespace Sybace\Pages\Controllers;

use Illuminate\Http\Request;
use Sybace\Pages\Controllers\PagesApiController as API;
...
//        $sections = Section::get();
    ...
    public function update(Request $request, $id)
    {
        ...
        //return redirect(action('\Sybace\Pages\Controllers\PagesController@dynamic-pages'));
    return redirect(Lang::getlocale() . "/" . 'admin/pages/dynamic');
        }
