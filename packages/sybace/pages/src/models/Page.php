...
//    protected $with = ['trans', 'author', 'lastUpdateBy', 'itemSection'];
    ...
    {
        return $this->hasOne('\Sybace\Pages\Models\PageTrans', 'page_id')->where('lang', Lang::getlocale())->select(['page_id', 'title', 'body','lang','page_seo_title','page_meta_keywords','page_meta_descriptions']);
    }
    ...
    {
        return $this->belongsTo('Sybace\Pages\Models\Section', 'section');
    }
