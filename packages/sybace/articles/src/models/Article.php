...
namespace Sybace\Articles\Models;
...
//    protected $with = ['trans', 'author', 'lastUpdateBy', 'itemSection'];
    ...
    {
//        return $this->hasOne('\Sybace\Articles\Models\ArticleTrans', 'article_id')->where('lang', Lang::getlocale())->select(['article_id', 'title', 'body','lang','article_seo_title','article_meta_keywords','article_meta_descriptions']);
        return $this->hasOne('\Sybace\Articles\Models\ArticleTrans', 'article_id')->where('lang', Lang::getlocale());
    }
    ...
    {
        return $this->belongsTo('sybace\Articles\Models\Section', 'section');
    }
