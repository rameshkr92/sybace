<?php 
namespace Sybace\Articles\Controllers;

use Illuminate\Http\Request;
use Sybace\Articles\Controllers\ArticlesApiController as API;
use Sybace\Articles\Models\Article;
use Sybace\Articles\Models\ArticleTrans;
use Illuminate\Support\Facades\Lang;
//use Sybace\Articles\Models\Section;
...
//        $sections = Section::get();
    ...
    public function update(Request $request, $id)
    {
        ...
        //return redirect(action('\Sybace\Articles\Controllers\ArticlesController@dynamic-articles'));
    return redirect(Lang::getlocale() . "/" . 'admin/articles');
        }
