<?php
namespace Sybace\Stores\Controllers;

use Illuminate\Http\Request;
use Sybace\Activities\Models\Activity;
use Sybace\Stores\Controllers\StoresApiController as API;
use Sybace\Stores\Models\Store;
use Sybace\Stores\Models\StoreTrans;
use Sybace\Stores\Models\StoreImage;
...
//        dd($request);
        ...
        return redirect(action('\Sybace\Stores\Controllers\StoresController@index'));
    }
...
//dd($item);
    ...
    public function deleteStoreGalleryImages(Request $request) {
        \Sybace\Stores\Models\StoreImage::where('id', $request->id)->delete();
        echo "1";
    }
