...
//    ];
    ...
    {
//        return $this->hasOne('\Sybace\Stores\Models\StoreTrans', 'store_id')->where('lang', Lang::getlocale())->select(['store_id', 'name']);
        return $this->hasOne('\Sybace\Stores\Models\StoreTrans', 'store_id')->where('lang', Lang::getlocale());
    }

    public function images()
    {
//        return $this->hasMany('\Sybace\Stores\Models\StoreImage', 'store_id')->select(['store_id', 'options']);
        return $this->hasMany('\Sybace\Stores\Models\StoreImage', 'store_id')->select(['store_id', 'options']);
    }
    //ratings
    ...
    {
//        return $this->hasMany('\Sybace\Stores\Models\StoreImage', 'store_id')->select(['store_id', 'options']);
        return $this->hasMany('\Sybace\Ratings\Models\Rating', 'store_id');
    }
    /**
     * Activity relation.
     */
    ...
    {
//        return $this->belongsTo('Sybace\Activities\Models\ActivityTrans', 'activity_id')->where('lang', Lang::getlocale())->select(['id', 'name']);
        return $this->belongsTo('Sybace\Activities\Models\Activity', 'activity_id')->select(['id']);
    }
	/**
     * Author relation.
     */
    ...
    {
        return $this->belongsTo('Sybace\Users\Models\User', 'created_by')->select(['id', 'name']);
    }
 ...
 //    public function getlastUpdateByAttribute()
    ...
    {
        return $this->belongsTo('Sybace\Users\Models\User', 'updated_by')->select(['id', 'name']);
    }
