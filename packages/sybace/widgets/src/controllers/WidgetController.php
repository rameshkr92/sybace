<?php
namespace Sybace\Widgets\Controllers;

use Illuminate\Http\Request;
use Sybace\Widgets\Controllers\WidgetsApiController as API;
use Sybace\Widgets\Models\Widgets;
use Sybace\Widgets\Models\WidgetsTrans;
...
//        ]);
        ...
        return redirect(action('\Sybace\Widgets\Controllers\WidgetController@index'));
    }
    ...
    public function edit($id)
    {
        ...
        $trans = \Sybace\Widgets\Models\WidgetTrans::where('widget_id', $id)->get()->keyBy('lang')->toArray();
//        dd($item->trans);
