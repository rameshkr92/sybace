...
<div class="row">
    <div class="col-md-12">
        <div class="admin-top-operation">
            <a class="btn btn-default" href="{{ action('\Sybace\Media\Controllers\MediaController@upload')}}">Upload</a>
        </div>
                    ...
                    <tr>
                        <td>
                            <strong class="has-media-icon">
                                <a href="{{ action('\Sybace\Media\Controllers\MediaController@edit', $file->id)}}" aria-label="“dog usage” (Edit)">
                        ...
                        <td>
                            ...
                            <a href="{{ action('\Sybace\Media\Controllers\MediaController@confirmDelete', $file->id)}}">Delete</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
