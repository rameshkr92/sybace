@php
    ...
    $breadcrumbs[] =  ['url' => url('/').'/'.Lang::getLocale().'/admin/tutorials', 'name' => trans('Tutorials::tutorials.courses')];
    $action = action('\Sybace\Tutorials\Controllers\CoursesController@store');
    $method = '';
    ...
    $action = action('\Sybace\Tutorials\Controllers\CoursesController@update', $item->id);
    $method = 'PATCH';
