<?php
namespace Sybace\Activities\Controllers;

use Illuminate\Http\Request;
use Sybace\Activities\Controllers\ActivitiesApiController as API;
use Sybace\Activities\Models\Activity;
use Sybace\Activities\Models\ActivityTrans;
...
//        ]);
        ...
        return redirect(action('\Sybace\Activities\Controllers\ActivitiesController@index'));
    }
