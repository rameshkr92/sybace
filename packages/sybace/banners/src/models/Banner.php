...
namespace Sybace\Banners\Models;
...
//    protected $with = ['trans'];
    ...
    {
        return $this->hasOne('\Sybace\Banners\Models\BannerTrans', 'banner_id')->where('lang', Lang::getlocale())->select(['banner_id', 'name', 'banner_img','url']);
    }
