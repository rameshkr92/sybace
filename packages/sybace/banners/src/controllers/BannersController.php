<?php
namespace Sybace\Banners\Controllers;

use Illuminate\Http\Request;
use Sybace\Banners\Controllers\BannersApiController as API;
use Sybace\Banners\Models\Banner;
use Sybace\Banners\Models\BannerTrans;
...
//        $sections = Section::get();
    ...
    public function store(Request $request)
    {
        ...
        return redirect(action('\Sybace\Banners\Controllers\BannersController@index'));
    }
