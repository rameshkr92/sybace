<?php 
namespace Sybace\Countries\Controllers;

use Illuminate\Http\Request;
use Sybace\Countries\Controllers\CountriesApiController as API;
...
//            'phone_code' => 'required|unique:countries_trans',
        ...
        return redirect(action('\Sybace\Countries\Controllers\CountriesController@index'));
    }
