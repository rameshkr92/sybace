...
use Sybace\Countries\Controllers\AreasApiController as API;
...
class AreasController extends AreasApiController {
    ...
    public function store(Request $request) {
        ...
        return redirect(action('\Sybace\Countries\Controllers\AreasController@index'));
    }
