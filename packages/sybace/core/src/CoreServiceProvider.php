...
class CoreServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        */
        ...
        if( in_array($locale, array_column(config('sybace.locales'), 'code')) ){
        ...
        */
        ...
        $this->publishes([
            __DIR__.'/config/sybace.php' => config_path('sybace.php'),
        ], 'config');
    ...
    public function register()
    {
        ...
        */
        ...
        $this->mergeConfigFrom(
            __DIR__.'/config/sybace.php', 'sybace'
        );
        ...
        //$this->app->make('Sybace\Products\Controllers\ProductsApiController');
        //$this->app->make('Sybace\Products\Controllers\ProductsController');
    }
}
