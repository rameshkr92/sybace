...
//    ];
    ...
    {
//        return $this->hasOne('\Sybace\Tasks\Models\TaskTrans', 'store_id')->where('lang', Lang::getlocale())->select(['store_id', 'name']);
        return $this->hasOne('\Sybace\Tasks\Models\TaskTrans', 'store_id')->where('lang', Lang::getlocale());
    }

    public function images()
    {
//        return $this->hasMany('\Sybace\Tasks\Models\TaskImage', 'store_id')->select(['store_id', 'options']);
        return $this->hasMany('\Sybace\Tasks\Models\TaskImage', 'store_id')->select(['store_id', 'options']);
    }
    //ratings
