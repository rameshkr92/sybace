<?php
namespace Sybace\Tasks\Controllers;

use Illuminate\Http\Request;
use Sybace\Activities\Models\Activity;
use Sybace\Tasks\Controllers\TasksApiController as API;
use Sybace\Tasks\Models\Task;
use Sybace\Tasks\Models\TaskTrans;
use Sybace\Tasks\Models\TaskImage;
...
//        dd($request);
        ...
        return redirect(action('\Sybace\Tasks\Controllers\TasksController@index'));
    }
    ...
    public function edit($id)
    {
        ...
        $gallery_count = \Sybace\Tasks\Models\TaskImage::where('task_id', $id)->get();
...
//dd($item);
    ...
    public function deleteTaskGalleryImages(Request $request) {
        \Sybace\Tasks\Models\TaskImage::where('id', $request->id)->delete();
        echo "1";
    }
