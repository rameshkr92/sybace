...
//    protected $with = ['trans', 'author', 'lastUpdateBy', 'itemSection'];
    ...
    {
//        return $this->hasOne('\Sybace\Contactus\Models\ContactusTrans', 'contact_id')->where('lang', Lang::getlocale())->select("*");
        return $this->hasOne('\Sybace\Contactus\Models\ContactusTrans', 'contact_id')->select("*");
    }
    ...
    {
        return $this->belongsTo('Sybace\Contactus\Models\ContactusSectionTrans', 'section_id');
    }
