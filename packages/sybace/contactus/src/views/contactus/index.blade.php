                                        ...
                                        <tr @if($item->trans) data-title="{{ $item->trans->name }}" @endif>
                                            ...
                                            <td>
                                                @if($item->trans->section_id)
                                                    <?php
                                                    $sec = Sybace\Contactus\Models\ContactusSectionTrans::where(array('section_id' => $item->trans->section_id,'lang' => Lang::getlocale()))->first();
                                                    if (isset($sec)) {
                                                        echo $sec->name;
                                                    }
                                                    ?>
            ...
            @else
                <div class="text-center">
                    <h1>{{ trans('admin.no_results_found') }}
                        {{--<a href="{{ action('\Sybace\Contactus\Controllers\ContactusController@index')}}">{{ trans('admin.back') }}</a>--}}
                    </h1>
                </div>
            @endif
        </div>
