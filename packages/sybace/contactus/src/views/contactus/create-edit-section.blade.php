@php
    ...
    $action = action('\Sybace\Contactus\Controllers\ContactusController@storeSection');
    $method = '';
    ...
    if(Request::is('*/edit')){
        ...
        $action = action('\Sybace\Contactus\Controllers\ContactusController@updateSection', $item->id);
        $method = 'PATCH';
