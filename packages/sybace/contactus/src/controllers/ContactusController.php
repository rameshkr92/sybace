...
namespace Sybace\Contactus\Controllers;

use Illuminate\Http\Request;
use Sybace\Contactus\Controllers\ContactusApiController as API;
use Sybace\Contactus\Models\Contactus;
use Sybace\Contactus\Models\ContactusSection;
use Sybace\Contactus\Models\ContactusSectionTrans;
use Sybace\Contactus\Models\ContactusTrans;
use Sybace\Contactus\Models\ContactusReply;
use Sybace\Contactus\Models\ContactusReplyTrans;
use Sybace\Settings\Models\Setting;
use Lang;

//use Sybace\Pages\Models\Section;

class ContactusController extends ContactusApiController {
    /*
      |--------------------------------------------------------------------------
      | Sybace Pages Controller
      |--------------------------------------------------------------------------
      |
...
//        $sections = Section::get();
    ...
    public function storeSection(Request $request) {
        ...
        return redirect(action('\Sybace\Contactus\Controllers\ContactusController@sectionIndex'));
    }
    /**
     *store contact section
     */
    public function store(Request $request) {
        ...
        return redirect(action('\Sybace\Pages\Controllers\PagesController@index'));
    }
