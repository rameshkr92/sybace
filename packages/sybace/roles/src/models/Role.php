...
class Role extends Model
{
    ...
    {
        return $this->hasOne('\Sybace\Roles\Models\RoleTrans', 'role_id')->where('lang', '=', Lang::getlocale());
    }
    ...
    {
        return $this->hasMany('Sybace\Users\Models\PermissionRole', 'role_id')->orderBy('id','ASC');
    }
