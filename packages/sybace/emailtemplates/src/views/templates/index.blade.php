    ...
    <div class="row">
        <div class="col-md-12">
            {{--<div class="admin-top-operation">--}}
                {{--<a class="btn btn-default" href="{{ action('\Sybace\Emailtemplates\Controllers\EmailTemplatesController@create')}}">{{ trans('Core::operations.create') }} {{ trans('Emailtemplates::emailtemplate.emailtemplates') }}</a>--}}
            {{--</div>--}}
                ...
                <table class="table table-striped table-hover">
                    ...
                    @foreach($items as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ action('\Sybace\Emailtemplates\Controllers\EmailTemplatesController@edit', $item->id) }}"><i class="fa fa-edit"></i> {{ trans('Core::operations.edit') }}</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
