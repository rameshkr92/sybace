...
namespace Sybace\Emailtemplates\Controllers;

use Illuminate\Http\Request;
use Sybace\Emailtemplates\Controllers\EmailTemplatesApiController as API;
use Sybace\Emailtemplates\Models\EmailTemplate;
use Sybace\Emailtemplates\Models\EmailTemplateTrans;
...
//        dd($request);
        ...
        return redirect(action('\Sybace\Emailtemplates\Controllers\EmailTemplatesController@index'));
    }
