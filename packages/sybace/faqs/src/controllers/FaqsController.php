<?php 
namespace Sybace\Faqs\Controllers;

use Illuminate\Http\Request;
use Sybace\Faqs\Controllers\FaqsApiController as API;
use Sybace\Faqs\Models\Faq;
use Sybace\Faqs\Models\FaqTrans;
use Illuminate\Support\Facades\Lang;
//use Sybace\Faqs\Models\Section;
...
//        $sections = Section::get();
    ...
    public function update(Request $request, $id)
    {
        ...
        //return redirect(action('\Sybace\Faqs\Controllers\FaqsController@dynamic-faqs'));
    return redirect(Lang::getlocale() . "/" . 'admin/faqs');
        }
