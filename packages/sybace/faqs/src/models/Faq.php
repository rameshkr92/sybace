...
//    protected $with = ['trans', 'author', 'lastUpdateBy', 'itemSection'];
    ...
    {
//        return $this->hasOne('\Sybace\Faqs\Models\FaqTrans', 'faq_id')->where('lang', Lang::getlocale())->select(['faq_id', 'title', 'body','lang','faq_seo_title','faq_meta_keywords','faq_meta_descriptions']);
        return $this->hasOne('\Sybace\Faqs\Models\FaqTrans', 'faq_id')->where('lang', Lang::getlocale());
    }
    ...
    {
        return $this->belongsTo('sybace\Faqs\Models\Section', 'section');
    }
