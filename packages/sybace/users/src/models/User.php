...
class User extends Authenticatable
{
    ...
    {
        return $this->hasOne('Sybace\Users\Models\UserRole', 'user_id');
    }

    public function getProfileImage()
    {
        return $this->hasOne('Sybace\Users\Models\UserRole', 'uploaded_by');
    }
    ...
    public function mainImage()
    {
        ...
        if($options && $options['media'] && isset($options['media']['main_image_id'])){
            ...
            $media = \Sybace\Media\Models\Media::find($mainImageId);
...
//        return $this->mediaOptions;
    ...
    {
        return $this->belongsTo('Sybace\Users\Models\User', 'created_by')->select(array('id', 'name'));
    }
    ...
    {
        return $this->belongsTo('Sybace\Users\Models\User', 'updated_by')->select(array('id', 'name'));
    }
    ...
    {
        return $this->belongsTo('Sybace\Countries\Models\Country', 'country_id');
    }
    ...
    {
        return $this->belongsTo('Sybace\Countries\Models\CountryTrans', 'country_id' , 'country_id')->select(array('country_id','name'));
    }
    ...
    {
        return $this->belongsTo('Sybace\Countries\Models\Area', 'area_id')->select(array('id'));
    }
    ...
    {
        return $this->belongsTo('Sybace\Countries\Models\AreaTrans', 'area_id' , 'area_id')->select(array('area_id','name'));
    }
    ...
    {
        return $this->hasMany('Sybace\Users\Models\PermissionUser', 'user_id');

    }

    public function hasRole()
    {
        return $this->hasOne('Sybace\Users\Models\UserRole', 'user_id')->select("role_id");
