<?php
namespace Sybace\Ads\Controllers;

use Illuminate\Http\Request;
use Sybace\Ads\Controllers\AdsApiController as API;
use Sybace\Ads\Models\Ad;
use Sybace\Ads\Models\AdTrans;
...
//        ]);
        ...
        return redirect(action('\Sybace\Ads\Controllers\AdsController@index'));
    }
